...
Player.create(name: "Mark U.", high_score: 0)
...
QuizCard.create(player_id: 4, option1: "Is Latina.", option2: "Has licked a donut.", option3: "Has won ten Teen Choice awards.", false_option: 1)
...
QuizCard.create(player_id: 15, option1: "I helped my friend write a song for a famous pop star", option2: "My ancestors attempted to assassinate George Washington", option3: "My bands only have followings in Eastern Europe and Montreal", false_option: 1)
